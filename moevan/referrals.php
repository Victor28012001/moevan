    ...
    <body>
        ...
        ";
                ...
                <div class="wallet-balance">
                    <img src="moevan icons\🦆 icon _people_.svg" alt="">
                    <div>
                        <h4>Total Referral</h4>
                        <h4>
                            <?php echo $result['referralpoint']; ?>
                        </h4>
                    </div>
                </div>
                ...
                <div class="wallet-balance" style="margin-bottom: 5vh">
                    <img src="moevan icons\🦆 icon _coins_.svg" alt="">
                    <div>
                        <h4>Referral Bonus</h4>
                        <h4>N
                            <?php echo $result['referralbonus']; ?>
                        </h4>
                    </div>
                </div>
            ...
            <div class="fund-wallet" name="convert">
