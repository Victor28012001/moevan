        ...
        <div id="layoutSidenav">
            ...
            <div id="layoutSidenav_content">
                <main>
                    ...
                    <div class="row">
                        <?php
                        $query = mysqli_query($con, "select tsn from transactions");
                        $totaltransactions = mysqli_num_rows($query);
                        ?>

                        <div class="col-xl-3 col-md-6">
                            <div class="card bg-primary text-white mb-4">
                                <div class="card-body">Total Transactions Made
                                    <span style="font-size:22px;">
                                        <?php echo $totaltransactions; ?>
                                    </span>
                                </div>
                                <div class="card-footer d-flex align-items-center justify-content-between">
                                    <a class="small text-white stretched-link" href="manage-transactions.php">View
                                        Details</a>
                                    <div class="small text-white"><i class="fas fa-angle-right"></i></div>
                                </div>
                            </div>
                        ...
                        <?php
                        $query1 = " SELECT tsn FROM transactions where date(posting_date)=CURRENT_DATE()-1";
                        $quer1 = mysqli_query($con, $query1);
                        $yesterdayregusers = mysqli_num_rows($quer1);
                        ...
                        <?php
                        $query2 = mysqli_query($con, "select tsn from transactions where date(posting_date)>=now() - INTERVAL 7 day");
                        $last7daysregusers = mysqli_num_rows($query2);
                        ?>
                        ...
                        <?php
                        $query3 = mysqli_query($con, "select tsn from transactions where date(posting_date)>=now() - INTERVAL 30 day");
                        $last30daysregusers = mysqli_num_rows($query3);
                        ?>
